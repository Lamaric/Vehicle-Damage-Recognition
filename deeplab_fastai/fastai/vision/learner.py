...
# Split a resnext style model
def _resnext_split(m:nn.Module): return (m[0][6],m[1])
...
_resnext_meta     = {'cut':-2, 'split':_resnext_split }#Split a resnext
...
model_meta = {
    ...
    models.resnext50:{**_resnext_meta},
    }#Split a resnext
